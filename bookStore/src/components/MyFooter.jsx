          ...
          <div className="w-full">
            <div className="grid w-full grid-cols-2 gap-8 px-6 py-8 md:grid-cols-4">
              ...
              <div>
                ...
                <Footer.LinkGroup col>
                  <Footer.Link href="https://discord.com/channels/anandkr369" target='_blank'>Discord</Footer.Link>
                  <Footer.Link href="https://twitter.com/im_anand0018" target='_blank'>Twitter</Footer.Link>
              ...
              <div>
                ...
                <Footer.LinkGroup col>
                <Footer.Icon href="https://instagram.com/im_anand0018" target='_blank' icon={BsInstagram} />
                <Footer.Icon href="https://twitter.com/im_anand0018" target='_blank' icon={BsTwitter} />
                <Footer.Icon href="facebook.com" target='_blank' icon={BsFacebook} />
                <Footer.Icon href="https://github.com/anandkr369/" target='_blank' icon={BsGithub} />
                </Footer.LinkGroup>
              </div>
            </div>
